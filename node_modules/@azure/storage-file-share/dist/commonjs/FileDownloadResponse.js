...
class FileDownloadResponse {
    ...
    get readableStreamBody() {
        return core_util_1.isNodeLike ? this.fileDownloadStream : undefined;
    }
    get _response() {
    ...
    constructor(originalResponse, getter, offset, count, options = {}) {
        this.originalResponse = (0, utils_common_js_1.assertResponse)(originalResponse);
        this.fileDownloadStream = new RetriableReadableStream_js_1.RetriableReadableStream(this.originalResponse.readableStreamBody, getter, offset, count, options);
    }
}
